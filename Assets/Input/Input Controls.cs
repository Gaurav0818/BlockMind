...
public partial class @InputControls : IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": [
        ...
        m_Gameplay_LookShoot = m_Gameplay.FindAction("Look / Shoot", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Gameplay_LookShoot;
    public struct GameplayActions
    {
        private @InputControls m_Wrapper;
        public GameplayActions(@InputControls wrapper) { m_Wrapper = wrapper; }
        public InputAction @Move => m_Wrapper.m_Gameplay_Move;
        public InputAction @LookShoot => m_Wrapper.m_Gameplay_LookShoot;
        ...
        public void SetCallbacks(IGameplayActions instance)
        {
            if (m_Wrapper.m_GameplayActionsCallbackInterface != null)
            {
                ...
                @LookShoot.started -= m_Wrapper.m_GameplayActionsCallbackInterface.OnLookShoot;
                @LookShoot.performed -= m_Wrapper.m_GameplayActionsCallbackInterface.OnLookShoot;
                @LookShoot.canceled -= m_Wrapper.m_GameplayActionsCallbackInterface.OnLookShoot;
            }
